...
public class JeuGOT extends Jeu{
    ...
    public static void QuestionsHiver(){
    ...
    public static void initJeuGot(){
        if(Jeu.nbTours > 1 && Jeu.nbTours % 10 == 0){
            System.out.println("Winter is coming my Lord");
            DureeHiver = 5;
            while(DureeHiver > 0 ){
                QuestionsHiver();
            }
            if(DureeHiver == 0){
                System.out.println("Winter is over my Lord");
            }
        }
    }
}